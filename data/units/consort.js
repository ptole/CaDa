...
class Consort extends Entity {

    constructor() {
        super();
        super.name = "High Consort Meldrarrian";
        super.description = "Mother of hundreds of dragonkin.";
        super.sprite = AM.sprites["consort"];
    ...
    bossDeath() {
        ...
        LOG.innerHTML += `${this.name}:<br>`;
        LOG.innerHTML += `*High pitched screech*<br>`;
